...
//        }
    ...
    private ResearchResultSetItem buildVitalResultSet(List<? extends IResearchEncounter> encounters, ResearchFilterItem filters) {
        ...
        for (IResearchEncounter encounter : encounters) {
            ...
            // get secondary data
            resultSet = this.buildSecondaryResultSet(encounter, filters, resultSet, resultItem, patient);
    ...
    //used for getting the secondary results of the set
    private ResearchResultSetItem buildSecondaryResultSet(IResearchEncounter encounter,
                                                          ResearchFilterItem filters,
                                                          ResearchResultSetItem resultSet,
                                                          ResearchResultItem resultItem,
                                                          IPatient patient){
        if (filters.getSecondaryDataset() != null) {
            if (filters.getSecondaryDataset().equals("gender")) {
